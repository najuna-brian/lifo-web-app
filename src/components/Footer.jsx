...
const Footer = () => {
    ...
    const socialLinks = [
        {
            name: 'Facebook',
            url: 'https://facebook.com/lifoundation',
            icon: (
        ...
        {
            name: 'Instagram',
            url: 'https://instagram.com/lifoundation',
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        {
            name: 'Twitter',
            url: 'https://twitter.com/lifoundation',
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-neutral-300 mb-6 max-w-md">
                            Restoring dignity through clean clothing. Join our mission to make a lasting impact 
                            in communities by providing access to clean laundry and clothing donations.
                        </p>
